...
<span class="icon bar"></span>
    ...
    <div class="navbar-header">
      <a class="navbar-brand" href="index.jsp">mobile world</a>
...
<ul class="nav navbar-nav">
 ...
 <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown">Category<span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="indexProduct">Nokia</a></li>
          <li><a href="indexProduct">Samsung</a></li>
          <li><a href="indexProduct">iphone</a></li>
          <li><a href="indexProduct">gionee</a></li>          
        </ul>
      </li>    
